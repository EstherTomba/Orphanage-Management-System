...
<body>
    ...
    <?php include("header.php")?>
        <div class="main_content"> 
            <div class="header" style="color: red; font-size: 20px;">Child Approved
            <?php 
            ...
            <div class="info">
                ...
                <table>
                    ...
                    <?php 
                        if($yearIsTrue) {
                            $childApprovalQuery= "SELECT * FROM childapproval WHERE status='Approved' AND YEAR(createdAt) = '$theYear' ORDER BY  createdAt DESC";
                        } elseif($monthIsTrue) {
                            $childApprovalQuery= "SELECT * FROM childapproval WHERE status='Approved' AND YEAR(createdAt) = '$theYear' AND MONTH(createdAt) = '$theMonth' ORDER BY  createdAt DESC";
                        } elseif($dayIsTrue) {
                            $childApprovalQuery= "SELECT * FROM childapproval WHERE status='Approved' AND YEAR(createdAt) = '$theYear' AND MONTH(createdAt) = '$theMonth' AND DAY(createdAt) = '$theDay' ORDER BY  createdAt DESC"; 
                        } elseif($searchIsTrue) {
                            $childApprovalQuery= "SELECT * FROM childapproval WHERE status='Approved' AND childAdmissionId.applicantFirstName LIKE '%$search%' ORDER BY  createdAt DESC"; 
                        }
