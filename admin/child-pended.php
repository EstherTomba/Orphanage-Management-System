                ...
                <table>
                    ...
                    <?php 
                        if($yearIsTrue) {
                            ...
                            WHERE status='Pending' AND YEAR(b.createdAt) = '$theYear' ORDER BY  b.createdAt DESC";
                        } elseif($monthIsTrue) {
                            $childApprovalQuery= "SELECT a.status, a.childAdmissionId, a.childApprovalId, b.applicantFirstName, 
                            b.applicantLastName, b.applicantEmail, b.applicantPhoneNumber, b.childFirstName, b.childLastName, b.createdAt
                            FROM childapproval AS a INNER JOIN childadmission AS b ON a.childAdmissionId = b.childAdmissionId 
                            WHERE status='Pending' AND YEAR(b.createdAt) = '$theYear' AND MONTH(b.createdAt) = '$theMonth' ORDER BY  b.createdAt DESC";
                        } elseif($dayIsTrue) {
                            $childApprovalQuery= "SELECT a.status, a.childAdmissionId, a.childApprovalId, b.applicantFirstName, 
                            b.applicantLastName, b.applicantEmail, b.applicantPhoneNumber, b.childFirstName, b.childLastName, b.createdAt
                            FROM childapproval AS a INNER JOIN childadmission AS b ON a.childAdmissionId = b.childAdmissionId 
                            WHERE status='Pending' AND YEAR(b.createdAt) = '$theYear' AND MONTH(b.createdAt) = '$theMonth' AND DAY(b.createdAt) = '$theDay' ORDER BY  createdAt DESC"; 
                        } elseif($searchIsTrue) {
                            $childApprovalQuery= "SELECT a.status, a.childAdmissionId, a.childApprovalId, b.applicantFirstName, 
                            b.applicantLastName, b.applicantEmail, b.applicantPhoneNumber, b.childFirstName, b.childLastName, b.createdAt
                            FROM childapproval AS a INNER JOIN childadmission AS b ON a.childAdmissionId = b.childAdmissionId
                        ...
                        while($row = mysqli_fetch_assoc($childApprovalResult)) {
                            ?>
                                <tr>
                                    <td><a href="child-pended-details.php?id=<?php echo $row['childApprovalId'] ?>"><?php echo $row['applicantFirstName'] ?></a></td>
