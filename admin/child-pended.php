        ...
        <div class="main_content">
            ...
            <div class="info">
                ...
                <table>
                    ...
                    <?php 
                        if($yearIsTrue) {
                            $childApprovalQuery= "SELECT * FROM childapproval WHERE status='Pending' AND  YEAR(createdAt) = '$theYear' ORDER BY  createdAt DESC";
                        } elseif($monthIsTrue) {
                            $childApprovalQuery= "SELECT * FROM childapproval WHERE status='Pending' AND YEAR(createdAt) = '$theYear' AND MONTH(createdAt) = '$theMonth' ORDER BY  createdAt DESC";
                        } elseif($dayIsTrue) {
                            $childApprovalQuery= "SELECT * FROM childapproval WHERE status='Pending' AND YEAR(createdAt) = '$theYear' AND MONTH(createdAt) = '$theMonth' AND DAY(createdAt) = '$theDay' ORDER BY  createdAt DESC"; 
                        } elseif($searchIsTrue) {
